    ...
    return (
        <div>
            <div className="border-2 rounded-md shadow-xl">
                ...
                <button onClick={() => handleClick(props.product)} className='w-full bg-orange-200 hover:bg-orange-400 h-10'>Add To Cart <FontAwesomeIcon icon={faShoppingCart} /></button>
